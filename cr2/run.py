"""
Main runner for the crawler.
Loads coordinates from .env and processes each location page by page.
"""
...
def main():
    ...
    - Loads coordinates from .env file
    - For each coordinate, fetches pages one by one
    """
